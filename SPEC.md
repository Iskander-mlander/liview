...
- Carga de imágenes: instantánea (lazy loading + texture cache)
- Memoria: ~20-30MB
- Sin dependencias pesadas (no GTK, no Qt)
- Carga solo nombres de archivos al inicio (lazy scan)
- Pre-carga imágenes anterior y siguiente para navegación fluida
...
├── debian/             # Paquetes Debian
├── PKGBUILD            # Paquete Arch Linux AUR
├── README.md           # Documentación
├── SPEC.md             # Este archivo
└── uca.xml             # Integración Thunar
```
...
- SDL2_image
- SDL2_ttf
- YAD (reemplaza Zenity - más eficiente)
- C++17
...
```bash
# Abrir imagen específica (abre directorio sin recursividad)
./xfce-liview imagen.jpg

# Abrir directorio (con recursividad)
./xfce-liview ~/Imágenes

# Abrir directorio con recursividad forzada
./xfce-liview -r ~/Imágenes
```
